...
# Clone Impact Pack with all submodules - pinned to v7.2 for ComfyUI compatibility
RUN git clone --recursive https://github.com/ltdrdata/ComfyUI-Impact-Pack /comfyui/custom_nodes/ComfyUI-Impact-Pack && \
    ...
    git checkout tags/7.2 && \
    git submodule update --init --recursive

# Also clone Impact Subpack separately (contains UltralyticsDetectorProvider) - pinned version
